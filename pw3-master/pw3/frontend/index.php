...
<body class="container-fluid">
  ...
  <form class="card container position-absolute top-50 start-50 translate-middle w-25 p-4" method="post">
    ...
    <button type="submit" name="nutricionista" class="btn btn-success p-4 btn-block mb-4">Nutricionista</button>
    <button type="submit" name="funcionario" class="btn btn-success p-4 btn-block mb-4">Funcionário</button>
  </form>
