...
<body>
  ...
  <div class="container-fluid mt-5">
    ...
    <form class="container w-25 p-3 start-50 mt-5" method="post" action="" name="signup-form">
      ...
      <div class="row mb-4">
        ...
        <button class="btn btn-success btn-block mb-4" type="submit" name="register" value="register">Registrar-se</button>
